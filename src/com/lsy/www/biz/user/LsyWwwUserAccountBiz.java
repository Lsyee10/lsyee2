...
public interface LsyWwwUserAccountBiz {
    ...
    // 登录结果定义
    public static final String LOGIN_RST_EXIST = "kpkpWwwUserAccountBiz.login.exist";
    ...
    // 注册结果定义
    public static final String REGISTER_RST_LIMIT = "kpkpWwwUserAccountBiz.register.limit";
    public static final String REGISTER_RST_SUCCESS = "kpkpWwwUserAccountBiz.register.success";
    public static final String REGISTER_RST_NICKNAME_EXIST = "kpkpWwwUserAccountBiz.register.nickname.exist";
