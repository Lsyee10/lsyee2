...
<body>
	<section class="container">
        <header class="title">
            <h2>编辑精选</h2>
            <nav class="sm">
                <a href="/works/topic/choice.action?scope=all">全部精选(<s:property value="#request.totalNum"/>)</a>
                <a href="/works/topic/choice.action?scope=today">今日精选(<s:property value="#request.todayNum"/>)</a>
            </nav>
        </header>
        <!-- 列表开始 -->
