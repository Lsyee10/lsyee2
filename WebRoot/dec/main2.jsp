<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*" errorPage="/error.action"%>
...
<head>
	...
	<meta name="keywords" content="快拍,快拍快拍,摄影活动,深度摄影,摄影名家,摄影展览,每天看时间最好的照片,快拍之星,摄影基地,摄影微博,摄影器材,摄影论坛,名家访谈,抢书读,市民摄影节 -" />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".img img").lazyload({
                //图片延时加载
                threshold: 200, //灵敏度，距离屏幕200像素时提前加载，默认为0，生产环境请改为200
                effect: "fadeIn", //淡入效果
...
<body>
	<page:applyDecorator name="head2"/>
		<!--正文右侧-->
	  <decorator:body />
